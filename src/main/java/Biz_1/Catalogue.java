...
public class Catalogue extends AbstractPageObject {
    ...
    protected final By fieldForItemTitle = By.xpath("//div[@class=\"col-sm-12 col-md-9\"]//input[@class=\"form-control ng-pristine ng-untouched ng-invalid ng-invalid-required ng-valid-maxlength\"]");
