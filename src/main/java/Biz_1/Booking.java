...
public class Booking extends AbstractPageObject {
    ...
    protected final By currentDate = By.xpath("//li[@class=\"k-state-default k-nav-current\"]");
    protected final String BOOKING_PAGE = "http://bizplatform.co/Venue/CommandCenter#/bookings/scheduler/full";
